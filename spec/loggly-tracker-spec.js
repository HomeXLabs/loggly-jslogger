// configure for running outside browser
const jsdom = require("jsdom");
const dom = new jsdom.JSDOM(`<!DOCTYPE html><p>testing</p>`);
global.window = dom.window;
global.document = window.document;
require('../dist/loggly.tracker.js');
const _LTracker = window._LTracker;
const LogglyTracker = window.LogglyTracker;
...
describe("loggly.tracker", function() {
    ...
    it("sets uuid manually to object and cookie", function() {
        ...
        spyOn(_LTracker, 'setCookie').and.callThrough();
